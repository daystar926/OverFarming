...
func plants_setting():
	grow_time = Global.gt_total_corn
	amount = Global.fa_total_corn
	bgt = Global.bgt_total_corn
...
func _harvest() -> void:
	...
	var da_amount = Global.da_amount_cul("corn")
	for i in range (da_amount):
		var item = preload("res://scene/plants/plants_item/corn_item.tscn").instantiate()
